...
- Upgrade `@types/leaflet`, `@types/node`, `babel-core`, `babel-laoder`, `babel-preset-env`, `css-loader`, `leaflet`, `style-loader`, `supercluster`, `tslint`, `typescript`, and `uglifyjs-webpack-plugin` dependencies
